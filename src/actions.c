...
ACTION_TABLE ActionTable[] = {
  ...
  {MENU_MAIN,           "Main\nMenu",           "MAIN-M",       MIDI_KEY   | CONTROLLER_SWITCH},
  ...
  {MENU_NOISE,          "Noise\nMenu",          "NOISE-M",      MIDI_KEY   | CONTROLLER_SWITCH},
  ...
  {PS,                  "PS On/Off",            "PS-T",         MIDI_KEY   | CONTROLLER_SWITCH},
  {MENU_PS,             "PS Menu",              "PS-M",         MIDI_KEY   | CONTROLLER_SWITCH},
  ...
  {VK_PLAY_SLOT_3,      "VK Playback T3",       "VK-PLAY-T3",   MIDI_KEY   | CONTROLLER_SWITCH},
  {VK_PLAY_SLOT_4,      "VK Playback T4",       "VK-PLAY-T4",   MIDI_KEY   | CONTROLLER_SWITCH},
  {VK_PLAY_SLOT_5,      "VK Playback T5",       "VK-PLAY-T5",   MIDI_KEY   | CONTROLLER_SWITCH},
  {VK_PLAY_SLOT_6,      "VK Playback T6",       "VK-PLAY-T6",   MIDI_KEY   | CONTROLLER_SWITCH},
  {VK_STOP,             "VK Stop XMIT",         "VK-STOP-TX",   MIDI_KEY   | CONTROLLER_SWITCH},
  ...
  {MENU_RX,             "RX\nMenu",             "RX-M",         MIDI_KEY   | CONTROLLER_SWITCH},
