...
char *css =
  ...
  "  window, dialog, popover, menu, menubar {\n"
  "    background-color: #262626;\n"
  "    color: #e0e0e0;\n"
  "  }\n"
  "  combobox { font-size: 15px; background-color: #333333; color: #00CED1; }\n"
  "  combobox button { background-color: #333333; color: #00CED1; background-image: none; }\n"
  "  combobox window { background-color: #333333; }\n"
  "  combobox cellview { color: #00CED1; }\n"
  "  button   { font-size: 15px; background-color: #333333; color: #00CED1; background-image: none; }\n"
  "  checkbutton label { font-size: 15px; color: #e0e0e0; }\n"
  "  spinbutton { font-size: 15px; background-color: #333333; color: #00CED1; }\n"
  "  spinbutton entry { background-color: #333333; color: #00CED1; }\n"
  "  spinbutton button { background-color: #404040; color: #00CED1; }\n"
  "  radiobutton label  { font-size: 15px; color: #e0e0e0; }\n"
  "  scale { font-size: 15px; }\n"
  "  scale trough { background-color: #404040; }\n"
  "  scale slider { background-color: #00CED1; }\n"
  "  entry { font-size: 15px; background-color: #333333; color: #00CED1; }\n"
  "  label { color: #e0e0e0; }\n"
  "  frame { background-color: #262626; }\n"
  "  notebook { background-color: #262626; }\n"
  "  notebook tab { background-color: #333333; color: #00CED1; }\n"
  "  notebook tab:checked { background-color: #404040; color: #00FF00; }\n"
  "  scrolledwindow { background-color: #262626; }\n"
  "  treeview { background-color: #333333; color: #e0e0e0; }\n"
  "  treeview header button { background-color: #404040; color: #00CED1; }\n"
  "  list { background-color: #333333; color: #e0e0e0; }\n"
  "  row { background-color: #333333; color: #e0e0e0; }\n"
  "  row:selected { background-color: #006060; }\n"
  "  menuitem { background-color: #333333; color: #e0e0e0; }\n"
  "  menuitem:hover { background-color: #006060; }\n"
  "  separator { background-color: #505050; }\n"
  ...
  "    color: #e0e0e0;\n"
  "  }\n"
  "  textview.dxcluster-textview-linux text {\n"
  "    background-color: #333333;\n"
  "    color: #e0e0e0;\n"
  "  }\n"
  ...
  "    color: #e0e0e0;\n"
  "  }\n"
  "  textview.dxcluster-textview text {\n"
  "    background-color: #333333;\n"
  "    color: #e0e0e0;\n"
  "  }\n"
  ...
  "    color: #00CED1;\n"
  "  }\n"
  "  notebook { font-size: 15px; background-color: #262626; }\n"
  ...
  "    color: rgb(0%, 0%, 0%);\n"
  "    }\n"
  "  #small_button_with_border:hover label {\n"
  "    color: rgb(0%, 0%, 0%);\n"
  "    }\n"
  "  #small_toggle_button {\n"
  "    padding: 1px;\n"
  ...
  "  #small_toggle_button:focus,\n"
  "  #small_toggle_button:checked:hover,\n"
  "  #small_toggle_button:checked:focus,\n"
  "  #small_toggle_button:checked:active {\n"
  "    padding: 1px;\n"
  ...
  "    }\n"
  "  #small_toggle_button:checked label,\n"
  "  #small_toggle_button:active label,\n"
  "  #small_toggle_button:focus label {\n"
  "    color: rgb(0%, 0%, 0%);\n"                 // black text on label
  "    }\n"
  ...
  "  #medium_toggle_button:active,\n"
  "  #medium_toggle_button:focus,\n"
  "  #medium_toggle_button:checked:hover,\n"
  "  #medium_toggle_button:checked:focus,\n"
  "  #medium_toggle_button:checked:active {\n"
  "    padding: 1px;\n"
  "    border: 1px solid #006400;\n"
  "    border-radius: 6px;\n"
  "    font-family: 'JetBrains Mono', Tahoma, Sans;\n"
  ...
  "    color: rgb(0%, 0%, 0%);\n"                 // black text for contrast
  "    }\n"
  "  #medium_toggle_button.active label,\n"
  "  #medium_toggle_button:checked label,\n"
  "  #medium_toggle_button:active label,\n"
  "  #medium_toggle_button:focus label {\n"
  "    color: rgb(0%, 0%, 0%);\n"                 // black text on label
  "    }\n"
  "  #front_toggle_button {\n"
  "    padding: 1px;\n"
  ...
  "    font-weight: bold;\n"
  "    background-image: none;\n"
  "    background-color: rgb(100%, 20%, 20%);\n"    // red background for MUTE state
  "    color: rgb(100%, 100%, 100%);\n"             // white text for MUTE state
  "    }\n"
  ...
  "  #front_toggle_button:focus,\n"
  "  #front_toggle_button:checked:hover,\n"
  "  #front_toggle_button:checked:focus,\n"
  "  #front_toggle_button:checked:active {\n"
  "    padding: 1px;\n"
  "    border: 1px solid #006400;\n"
  "    border-radius: 6px;\n"
  "    font-family: 'JetBrains Mono', Tahoma, Sans;\n"
  ...
  "    color: rgb(0%, 0%, 0%);\n"                 // black text for contrast
  "    }\n"
  "  #front_toggle_button:checked label,\n"
  "  #front_toggle_button:active label,\n"
  "  #front_toggle_button:focus label {\n"
  "    color: rgb(0%, 0%, 0%);\n"                 // black text on label
  "    }\n"
