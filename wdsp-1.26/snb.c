...
void calc_snba (SNBA d) {
  ...
  d->inresamp  = create_resample (d->resamprun, d->bsize, d->in,      d->inbuff, d->inrate,       d->internalrate, 0.0, 0,
                                  2.0);
...
BPSNBA create_bpsnba (int run, int run_notches, int position, int size, int nc, int mp, double* in, double* out,
                      int rate,
